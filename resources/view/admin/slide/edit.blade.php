                            ...
                            <form class="row" action="<?= route('admin.slide.update' ,[$slide->id]) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        <?= errorText('image') ?>
                                        <img src="<?= asset($slide->image) ?>" alt="<?= $slide->title ?>" width="150" height="100" class="mt-4">
                                ...
                                <div class="col-md-12">
                                    <section class="form-group">
                                        ...
                                        <textarea class="form-control  <?= errorClass('body') ?>" id="body" rows="5" name="body" placeholder="متن ..."><?= oldOrValue('body',$slide->body) ?></textarea>
                                        <?= errorText('body') ?>
                                    </section>
                                </div>
