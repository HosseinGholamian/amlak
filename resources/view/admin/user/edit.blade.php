...
@section('head-tag')
    <title>ادمین | ویرایش کاربران</title>
@endsection
                            ...
                            <form class="row" action="<?= route('admin.user.update', [$user->id]) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        <input name="last_name" type="text" id="last_name"  value="<?= oldOrValue('last_name' , $user->last_name) ?>" class="form-control  <?= errorClass('first_name') ?>" placeholder="نام خانوادگی ...">
                                        <?= errorText('last_name') ?>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        <input name="avatar" type="file" id="avatar" class="form-control-file <?= errorClass('first_name') ?>">
                                        <img src="<?= asset($user->avatar) ?>" style="width:6rem;" alt="">
                                        <?= errorText('avatar') ?>
                                    </fieldset>
                                </div>
