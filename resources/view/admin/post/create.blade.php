...
@section('head-tag')
    <title>ادمین | ایجاد اخبار جدید</title>
@endsection
                                ...
                                <form class="row" action="<?= route('admin.post.store')?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            ...
                                            <input value="<?= empty(old('published_at'))  ? '' : old('published_at') ?>" name="published_at" type="date" id="published_at"
                                        ...
                                        <fieldset class="form-group">
                                            <div class="form-group">
                                                ...
                                                <select name="cat_id" class="select2 form-control <?= errorClass('cat_id')  ?>">
                                                    ...
                                                    <option value="<?= $category->id ?>"  <?= !empty(old('cat_id')) && old('cat_id')==$category->id ? 'selected'  :  ''?> ><?= $category->name ?></option>
                                                        <?php } ?>
                                                </select>
                                                <?= errorText('cat_id') ?>
                                            </div>
