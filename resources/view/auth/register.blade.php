                                ...
                                <div class="card-body pt-0">
                                    <form action="<?= route('auth.register') ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-label-group">
                                            <input  value="<?= old('first_name') ?>" type="text" name="first_name" id="first_name" class="form-control <?= errorClass('first_name') ?> " placeholder="نام" required>
                                            <label for="first_name">نام</label>
                                        </div>
                                        <div class="form-label-group">
                                            <input  value="<?= old('last_name') ?>" type="text" name="last_name" id="last_name" class="form-control <?= errorClass('last_name') ?>" placeholder="نام خانوادگی" required>
                                            <label for="last_name">نام خانوادگی</label>
                                        </div>
                                        <div class="form-label-group">
                                          
                                            <input value="<?= old('email') ?>" type="email" name="email" id="email" class="form-control <?= errorClass('email') ?>" placeholder="ایمیل" required>
                                        ...
                                        <div class="form-label-group">
                                            <input type="password" name="password" id="password" class="form-control <?= errorClass('password') ?>" placeholder="کلمه عبور" required>
