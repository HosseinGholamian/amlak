    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 search-wrap">
                ...
                <form action="<?= route('search.home') ?>" class="search-property" method="GET">
                    <div class="row">
                ...
                <div class="properties-slider owl-carousel ftco-animate">
                    ...
                    <div class="item">
                        <div class="properties">
                            <a href="<?= route('ads.home',[$newestAd->id]) ?>" class="img d-flex justify-content-center align-items-center" style="background-image: url(<?= asset($newestAd->image) ?>);">
                            ...
                            <div class="text p-3">
                                ...
                                <div class="d-flex">
                                    <div class="one">
                                        <h3><a href="<?= route('ads.home',[$newestAd->id]) ?>"> <?= $newestAd->title ?></a></h3>
                                        <p><?= $newestAd->type() ?></p>
                                    </div>
                                    <div class="two">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm col-md-6 col-lg ftco-animate">
                <div class="properties">
                    <a href="<?= route('ads.home',[$bestAd->id]) ?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url('<?= asset($bestAd->image) ?>');">
                        <div class="icon d-flex justify-content-center align-items-center">
                            <span class="icon-search2"></span>
                        </div>
                    </a>
                    <div class="text p-3">
                        ...
                        <div class="d-flex">
                            <div class="one">
                                <h3><a href="<?= route('ads.home',[$bestAd->id]) ?>"> <?=  $bestAd->title ?></a></h3>
                                <p> <?=  $bestAd->type() ?></p>
                            </div>
                            <div class="two">
                        ...
                        <p>  <?=  substr( html_entity_decode($bestAd->description) ,0 ,50 ) ?> </p>
                        <hr>
                        <p class="bottom-area d-flex">
                            <span><i class="flaticon-selection mx-1"></i>متر <?=  $bestAd->area ?></span>
                            <span class="ml-auto"><i class="flaticon-bathtub"></i><?=  $bestAd->toilet ?> </span>
