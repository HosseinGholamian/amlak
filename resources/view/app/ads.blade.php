    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?= route('index.home') ?>">خانه</a></span> <span class="mr-2"><a href="#">آگهی ها</a></span> <span>آگهی</span></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 Properties-single mt-4 mb-5 ftco-animate">
                        ...
                        <div class="d-md-flex mt-5 mb-5">
                            <ul>
                                <li><span>متراژ : </span>  <?=$advertise->area ?> متر</li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 ftco-animate">
                                <div class="properties">
                                    <a href="<?= route('ads.home',[$ads->id]) ?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?= asset($ads->image) ?>);">
                                    ...
                                    <div class="text p-3">
                                        ...
                                        <div class="d-flex">
                                            <div class="one">
                                                <h3><a href="<?= route('ads.home',[$ads->id]) ?>"><?= $ads->title ?></a></h3>
                                                <p><?= $ads->type() ?></p>
                                            </div>
                                            <div class="two">
                                                <span class="price"><?= $ads->amount ?> تومان</span>
                                            </div>
                                        </div>
                                        <p><?= $ads->address ?></p>
                                        <hr>
                                        <p class="bottom-area d-flex">
                                            <span><i class="flaticon-selection"></i> <?= $ads->area ?> متر</span>
